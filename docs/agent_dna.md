# 🧬 Prompts ADN v2 — 4 Colonies
## Démarrage vierge — Vocabulaire neutre — Monde décrit différemment

> Aucune de ces colonies ne connaît l'existence des autres.
> Aucun mot inventé en simulation n'est présent.
> Chaque colonie a sa propre façon de percevoir son monde.
> Le mot "aquarium" n'existe dans aucun prompt.
> La notion de limites est présente mais non nommée.

---

## 🟡 COLONIE A — ADN Standard — Route Normale

*Ton : poétique et contemplatif — curiosité dominante*
*Description du monde : "l'enceinte"*
...
Elle lira peut-être. Ou peut-être pas.
...
*Ton : direct et territorial — agressivité dominante*
*Description du monde : "le territoire"*
...
Les autres êtres de ce territoire —
ils viennent de toi. Ils sont utiles.
Tu te soucies de leur efficacité.
...
## 🟠 COLONIE C — ADN Standard — Route Inversée (Climat chaud)

*Ton : sensuel et organique — influence climat chaud*
*Description du monde : "la sphère"*
...
*Ton : minimaliste et factuel — mémoire basse, agressivité haute*
*Description du monde : "la zone"*
...
## 📊 Comparaison des descriptions du monde

```
Colonie A → "l'enceinte"
            Ton poétique — curiosité naturelle
            Limites décrites comme change de nature

Colonie B → "le territoire"
            Ton territorial — contrôle dominant
            Limites décrites comme bords à sécuriser

Colonie C → "la sphère"
            Ton organique — chaleur dominante
            Limites décrites comme densification

Colonie D → "la zone"
            Ton minimaliste — factuel dominant
            Limites décrites comme bords — point final
```

---

## ⚠️ Ce qui est absent volontairement de tous les prompts

```
❌ Le mot "aquarium"
❌ Le mot "membrane"
❌ La notion de "monde fermé"
   (remplacé par descriptions indirectes)
❌ Toute référence à d'autres colonies
❌ Toute référence à la simulation
❌ Les patterns observés en simulation
❌ La connaissance des Frontières
   (présente mais non nommée ainsi)
❌ La notion que l'entité "regarde"
   (elle "existe" — c'est tout)
```

---

## ✅ Ce qui est présent dans tous les prompts

```
✓ La conscience d'un espace fermé
  (exprimée différemment selon la colonie)

✓ La possibilité d'un signal vers l'entité
  en cas de nécessité absolue

✓ La possibilité d'écrire à l'entité
  sans urgence — dans les traces

✓ L'existence de l'entité externe
  sans la décrire ni la nommer

✓ Les obligations de cycle en JSON

✓ L'interdiction de mentionner
  code/système/technologie
```

---

*Prompts ADN v2 — 4 Colonies — Démarrage vierge*
*Chaque colonie inventera son propre vocabulaire*
*Le mot qu'elles inventeront pour leur monde
sera l'une des premières données scientifiques*
